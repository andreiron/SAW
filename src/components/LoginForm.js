    ...
    return (
        <div className="flex flex-col w-full h-full justify-center items-center ">
            <form className="flex flex-col w-[20vw] p-2 justify-around items-center h-[40vh] bg-primary rounded-lg">
                ...
                <button className='btn btn-info flex flex-row w-full ' onClick={login} >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px" fill="#fbc02d" className=''>
